...
Please download all the files in this repository to your local machine:
![Download Zip](readme/download.png?raw=true "Download Zip")

Then unzip the zipfile, and open self-storage-etobicoke/index.html in your browser of choice:
![Open Index.html](readme/open.png?raw=true "Open Index.html")

This is a sample page from a self storage website. This is a local business servicing Etobicoke, Ontario, Canada. Note that Etobicoke is a region of the Greater Toronto Area. There are many things wrong with this page in terms of on page SEO optimization. Please answer these two questions:
